...
public class TTTKAdmin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tttkadmin);
        AnhXa();
    ...
    private void AnhXa() {
        toolbartttk = findViewById(R.id.toolbartttkAD);
        btnUpdate = findViewById(R.id.btnUpdateAD);
        edname = findViewById(R.id.edt_tk_htAD);
        edaddress = findViewById(R.id.edt_tk_dchiAD);
        edphone = findViewById(R.id.edt_tk_sdtAD);
        eddate = findViewById(R.id.edt_tk_ngsinhAD);
        edemail = findViewById(R.id.edt_tk_emAD);
    }
}
