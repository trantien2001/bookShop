...
public class DoiMatKhauAD extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_doi_mat_khau_ad);
        AnhXa();
        ActionToolbar();
        setBtnResetPass();
    }
                ...
                if(!NewPass.equals("") && !OldPass.equals("")){
                    StringRequest stringRequest =  new StringRequest(Request.Method.POST, Server.DuongdanresetPass, new Response.Listener<String>() {
                        ...
                        protected Map<String, String> getParams() throws AuthFailureError {
                            ...
                            data.put("email", Login.taiKhoanDN.trim());
                            return data;
                        }
    ...
    private void AnhXa(){
        editNewPass = (EditText) findViewById(R.id.editNewPassAD);
        editOldPass = (EditText) findViewById(R.id.editOldPassAD);
        btnResetPass = (Button) findViewById(R.id.btnResetPassAD);
        toolbardmm = findViewById(R.id.toolbardmmAD);
    }
}